...
public class hangoutDialogView extends JDialog {
    ...
    public hangoutDialogView(forcastResult ctRes) {
        ...
        hangoutList.setModel(new AbstractListModel() {
            String[] values ;
            {
                values = new String[] {"Flight delays", "Mosquito status", "Dust & Dander status", "Dog Walking Comfort", "Running", "Golf", "Tennis", "Hiking", "Bicycling", "Skateboarding", "Outdoor Concert", "Beach & Pool"};
