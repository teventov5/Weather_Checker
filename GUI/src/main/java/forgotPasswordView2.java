...
public class forgotPasswordView2 extends JDialog {
    ...
    public forgotPasswordView2(User tempUser) {
        ...
        secretAnswerText.setBounds(139, 133, 166, 20);
        ...
        lblSecretQuestionText.setBounds(119, 86, 160, 14);
                ...
                submitButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            ...
                            else JOptionPane.showMessageDialog(new JFrame(), "Wrong secret answer!", "Dialog", JOptionPane.ERROR_MESSAGE);
